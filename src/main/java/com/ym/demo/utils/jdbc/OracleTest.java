package com.ym.demo.utils.jdbc;
...
//            String user = "szym";// 用户名,系统默认的账户名
            String password = "Config_110";// 你安装时选设置的密码
//            String password = "SK_1906";// 你安装时选设置的密码
            con = DriverManager.getConnection(url, user, password);// 获取连接
            System.out.println("连接成功！");
            String sql = "select * from mnt_processstatus t";// 预编译语句，“？”代表参数
//            String sql = "select max(ddatetime) as ddatetime  from radial  where ddatetime> to_date('2019-07-18 15:53:00','yyyy-mm-dd hh24:mi:ss')";// 预编译语句，“？”代表参数
